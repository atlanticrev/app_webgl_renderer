class ControlPanel extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const rangeTranslationXDisplay = rangeTranslationX.querySelector('.control-panel__range-display');
        ...
        const rangeTranslationYDisplay = rangeTranslationY.querySelector('.control-panel__range-display');
        ...
        const rangeRotation = this.querySelector('.control-panel__range-rotation');
        const rangeRotationInput = rangeRotation.querySelector('.control-panel__range-input');
        const rangeRotationDisplay = rangeRotation.querySelector('.control-panel__range-display');
        ...
        const rangeScaleDisplay = rangeScale.querySelector('.control-panel__range-display');
